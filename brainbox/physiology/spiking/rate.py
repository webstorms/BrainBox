...
def compute_firing_rates_for_dataset(input_to_spikes, dt, window_dt, stride_dt, pad_input, dataset, batch_size, device="cuda", dtype=torch.float, max_batches=None, **kwargs):
    get_firing_rates = lambda data, _: compute_firing_rates(input_to_spikes(data), dt, window_dt, stride_dt, pad_input)
