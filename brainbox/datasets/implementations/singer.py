...
class BBCWild(PredictionTemporalDataset):
    ...
    def __init__(self, root, sample_length, dt, pred_horizon=1, train=True, preprocess=None, transform=None, target_transform=None):
        n_clips = BBCWild._N_TRAIN_CLIPS if train else BBCWild._N_TEST_CLIPS
        super().__init__(root, sample_length, dt, n_clips, BBCWild._CLIP_LEN, pred_horizon, train, preprocess, transform,
                         target_transform)
