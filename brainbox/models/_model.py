...
class BBModel(nn.Module):
    ...
    def hyperparams(self):
        hyperparams = {'name': self.__class__.__name__, 'weight_initializers': self._weight_initializers}
    ...
    def init_weight(self, weight, init_type, **kwargs):
        ...
        if init_type == 'constant':
            ...
            w_initializer = _weight_init.Uniform(weight_name, kwargs.get('a', 0), kwargs.get('b', 1))
        elif init_type == 'glorot_uniform':
            w_initializer = _weight_init.GlorotUniform(weight_name)
        elif init_type == 'normal':
            w_initializer = _weight_init.Normal(weight_name, kwargs.get('mean', 0), kwargs.get('std', 1))
